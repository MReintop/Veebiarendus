...
<?php wp_head(); ?>
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-77829505-3"></script>
    <script>
        window.dataLayer = window.dataLayer || [];
        function gtag(){dataLayer.push(arguments);}
        gtag('js', new Date());

        gtag('config', 'UA-77829505-3');
    </script>
				...
				<div class="container">
					...
					<div class="navbar-header">
						...
						<?php
							...
							$parallax_one = get_theme_mod( 'paralax_one_logo', parallax_get_file( '/images/logo.png' ) );
